          ...
          {isLibraryOpen && createPortal(
            <div className="fixed inset-0 z-[9999]" style={{ pointerEvents: 'auto' }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-6">
                <div 
                  className="relative w-full max-w-4xl h-[88vh] sm:h-[90vh] bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden"
                  onClick={(e) => e.stopPropagation()}
                >
                  {/* Header */}
                  <div className="p-5 md:p-8 bg-slate-900 text-white flex-shrink-0">
                    <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                    {/* Categories */}
                    <div className="md:w-56 bg-slate-50 md:bg-white border-b md:border-b-0 md:border-r flex-shrink-0 overflow-x-auto">
